...
<div class="header-icons">
	...
	<?php if($this->session->userdata('email')) { ?>
		<a href="<?php echo base_url('dashboard') ?>" class="header-wrapicon1 dis-block">
			<img src="<?php echo base_url() ?>assets/upload/image/icon-header-01.png" class="header-icon1" alt="ICON"> <?php echo $this->session->userdata('nama_pelanggan');?> &nbsp;
		</a>

	<?php }else{ ?>
		<a href="<?php echo base_url('masuk') ?>" class="header-wrapicon1 dis-block">
			<img src="<?php echo base_url() ?>assets/upload/image/icon-header-01.png" class="header-icon1" alt="ICON">
		</a>
