			...
			<div class="flex-r-m flex-w p-t-10">
				<div class="w-size16 flex-m flex-w">
					...
					<div class="btn-addcart-product-detail size9 trans-0-4 m-t-10 m-b-10">
						<!-- Button -->
						<button type="submit" name="submit" onclick="alert('Tambahkan Ini ke Keranjang?')" value="submit" class="flex-c-m sizefull bg1 bo-rad-23 hov1 s-text1 trans-0-4">
							Add to Cart
						</button>
					</div>
				</div>
...
<div class="container">
	...
	<div class="wrap-slick2">
		<div class="slick2">
			...
			<div class="item-slick2 p-1-15 p-r-15">
			<?php echo form_open(base_url('belanja/add')); 
		...
		<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
			...
			<div class="block2-overlay trans-0-4">
				<a href="#" class="block2-btn-addwishlist hov-pointer trans-0-4">
					<i class="icon-wishlist fa fa-eye" aria-hidden="true"></i>
					<i class="icon-wishlist fa fa-eye dis-none" aria-hidden="true"></i>
				</a>
