	...
	<div class="wrap-table-shopping-cart bgwhite">
		...
		<table class="table-shopping-cart">
			<tr class="table-head">
				...
				<th class="column-2 p-l-60">Produk</th>
				<th class="column-3">Harga</th>
				<th class="column-4 p-l-70">Jumlah</th>
				<th class="column-5" width="17%">Sub Total</th>
				<th class="column-6 p-l-60" width="17%">Aksi</th>
			</tr>
			<?php 
			...
			<tr class="table-row bg-info">
				...
				<td colspan="2" class="column-2"><b>Rp. <?php echo number_format($this->cart->total(),'0',',','.') ?></b></td>
			</tr>
			
		</table>
		<br>
	<p class="pull-right"><a href="<?php echo base_url('belanja/hapus') ?>" class="btn btn-danger btn-sm">
